...
class order_line_wizard(models.TransientModel):
    ...
    product_details_option = fields.Selection(
        [
            ...
            ("from_pricelist", "Take Details With Adapted Pricelist"),
        ],
        default="from_xls",
    )
        ...
        if self.import_option == "csv":
                ...
                if values:
                    if i == 0:
                        ...
                        if self.product_details_option == "from_product":
                            values.update({"product": field[0], "quantity": field[1], "disc": field[6]})
            ...
            for row_no in range(sheet.nrows):
                ...
                if row_no <= 0:
                    ...
                    if self.product_details_option == "from_product":
                        values.update({"product": line[0].split(".")[0], "quantity": line[1], "disc": line[6]})
                    elif self.product_details_option == "from_xls":
                        values.update(
                            {
        ...
        if self.product_details_option == "from_product":
            if self.import_prod_option == "barcode":
                ...
                product_obj_search = self.env["product.product"].search(
                    [("default_code", "=", values["product"])], limit=1
                )
            else:
                                    ...
                                    if many2x_fields.ttype in ["many2one", "many2many"]:
                                        if many2x_fields.ttype == "many2one":
                                            if values.get(i):
                                                ...
                                                if fetch_m2o.id:
                                                    order_lines.update({technical_fields_name: fetch_m2o.id})
                                                else:
                                        ...
                                        if many2x_fields.ttype == "many2many":
                                            ...
                                            if values.get(i):
                                                if ";" in values.get(i):
                                                    ...
                                                    m2m_value_lst.append(m2m_id.id)
                                            order_lines.update({technical_fields_name: m2m_value_lst})
                                    else:
                                        raise ValidationError(
                                    ...
                                    if normal_fields.ttype == "boolean":
                                        ...
                                        if str(values.get(i)) == "TRUE":
                                            ...
                                            if int(str(values.get(i))) == 1:
                                                boolean_check = True
                                        order_lines.update({normal_details: boolean_check})
                                    elif normal_fields.ttype == "char":
                                        order_lines.update({normal_details: values.get(i)})
                                    elif normal_fields.ttype == "float":
                                        if values.get(i) == "":
                                            float_value = 0.0
                                        else:
                                            float_value = float(values.get(i))
                                        order_lines.update({normal_details: float_value})
                                        ...
                                        order_lines.update({normal_details: int_value})
