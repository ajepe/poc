...
class gen_product(models.TransientModel):
    ...
    product_option = fields.Selection(
        [("create", "Create Product"), ("update", "Update Product")], string="Option", required=True, default="create"
    )
    ...
    def create_product(self, values):
                    ...
                    if any_special:
                            ...
                            if many2x_fields.ttype in ["many2one", "many2many"]:
                                if many2x_fields.ttype == "many2one":
                                    if values.get(i):
                                        ...
                                        if fetch_m2o.id:
                                            custom_vals.update({technical_fields_name: fetch_m2o.id})
                                        else:
                                ...
                                if many2x_fields.ttype == "many2many":
                                    ...
                                    if values.get(i):
                                        if ";" in values.get(i):
                                            ...
                                            m2m_value_lst.append(m2m_id.id)
                                    custom_vals.update({technical_fields_name: m2m_value_lst})
                            else:
                                raise ValidationError(
                        ...
                        if normal_fields.id:
                            if normal_fields.ttype == "boolean":
                                custom_vals.update({normal_details: values.get(i)})
                                ...
                                custom_vals.update({normal_details: float_value})
                                ...
                                custom_vals.update({normal_details: int_value})
        ...
        res.product_tmpl_id.update({"is_import": True})
        return res
                        ...
                        if self.product_option == "create":
                            ...
                            if values.get("supplier_taxes_id"):
                                if ";" in values.get("supplier_taxes_id"):
                                    ...
                                    tax_names = values.get("supplier_taxes_id").split(",")
                                    tax = self.env["account.tax"].search(
                                        [("name", "in", tax_names), ("type_tax_use", "=", "purchase")]
                                    )
                                    if not tax:
                                        raise ValidationError(_('"%s" Tax not in your system') % tax_names)
                                    supplier_taxes_id.append(tax.id)
                                                ...
                                                if any_special:
                                                    ...
                                                    if many2x_fields.id:
                                                        if many2x_fields.ttype in ["many2one", "many2many"]:
                                                            ...
                                                            raise ValidationError(
                                                                _(
                                                                    '"%s" This custom field type is not many2one/many2many'
                                                                )
                                                    ...
                                                    if normal_fields.id:
                                                        if normal_fields.ttype == "boolean":
                                                            product_ids.update({normal_details: values.get(i)})
                                                        elif normal_fields.ttype == "char":
                                                            product_ids.update({normal_details: values.get(i)})
                                                        elif normal_fields.ttype == "float":
                                                            if values.get(i) == "":
                                                                ...
                                                                float_value = float(values.get(i))
                                                            product_ids.update({normal_details: float_value})
                                                        elif normal_fields.ttype == "integer":
                                                            if values.get(i) == "":
                                                                int_value = 0
                                                            else:
                                                            ...
                                                            product_ids.update({normal_details: int_value})
                                                        elif normal_fields.ttype == "selection":
                                                            product_ids.update({normal_details: values.get(i)})
                                                        elif normal_fields.ttype == "text":
                                                            product_ids.update({normal_details: values.get(i)})
                                    ...
                                    if count > 14:
                                        ...
                                        if normal_details.startswith("x_"):
                                            ...
                                            if any_special:
                                                        ...
                                                        if many2x_fields.ttype == "many2many":
                                                            ...
                                                            if line[count]:
                                                                if ";" in line[count]:
                                                                    ...
                                                                    m2m_value_lst.append(m2m_id.id)
                                                            product_ids.update({technical_fields_name: m2m_value_lst})
                                                    else:
                                                        raise ValidationError(
                                                            _('"%s" This custom field type is not many2one/many2many')
                                                            % technical_fields_name
                                                        )
                                                else:
                                                    raise ValidationError(
                                                ...
                                                if normal_fields.id:
                                                    if normal_fields.ttype == "boolean":
                                                        product_ids.update({normal_details: line[count]})
                                                    elif normal_fields.ttype == "char":
                                                        product_ids.update({normal_details: line[count]})
                                                    elif normal_fields.ttype == "float":
                                                        if values.get(i) == "":
