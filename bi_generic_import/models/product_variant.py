...
class gen_product_variant(models.TransientModel):
    ...
    product_search = fields.Selection(
        [("by_code", "Search By Code"), ("by_barcode", "Search By Barcode")], string="Search Product"
    )
                ...
                if any_special:
                        ...
                        if many2x_fields.ttype in ["many2one", "many2many"]:
                            if many2x_fields.ttype == "many2one":
                                if values.get(i):
                                    ...
                                    if fetch_m2o.id:
                                        res.update({technical_fields_name: fetch_m2o.id})
                                    else:
                            ...
                            if many2x_fields.ttype == "many2many":
                                ...
                                if values.get(i):
                                    if ";" in values.get(i):
                                        ...
                                        m2m_value_lst.append(m2m_id.id)
                                res.update({technical_fields_name: m2m_value_lst})
                        else:
                            raise ValidationError(
                    ...
                    if normal_fields.id:
                        if normal_fields.ttype == "boolean":
                            res.update({normal_details: values.get(i)})
                            ...
                            res.update({normal_details: float_value})
                            ...
                            res.update({normal_details: int_value})
                                            ...
                                            if any_special:
                                                ...
                                                if normal_fields.id:
                                                    if normal_fields.ttype == "boolean":
                                                        ...
                                                        res.update({normal_details: float(values.get(i))})
                                                    elif normal_fields.ttype == "integer":
                                                        if values.get(i) == "":
                                                            int_val = 0
                                                        else:
                                                        ...
                                                        res.update({normal_details: int_val})
                                                    elif normal_fields.ttype == "selection":
                                                        res.update({normal_details: values.get(i)})
                                                    elif normal_fields.ttype == "text":
                                                        res.update({normal_details: values.get(i)})
                                            ...
                                            if any_special:
                                                ...
                                                if normal_fields.id:
                                                    if normal_fields.ttype == "boolean":
                                                        ...
                                                        product_ids.update({normal_details: float(line[count])})
                                                    elif normal_fields.ttype == "integer":
                                                        if line[count] == "":
                                                            int_v = 0
                                                        else:
                                                        ...
                                                        product_ids.update({normal_details: int_v})
                                                    elif normal_fields.ttype == "selection":
                                                        product_ids.update({normal_details: line[count]})
                                                    elif normal_fields.ttype == "text":
                                                        product_ids.update({normal_details: line[count]})
