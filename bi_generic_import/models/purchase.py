                    ...
                    if any_special:
                            ...
                            if many2x_fields.ttype in ["many2one", "many2many"]:
                                if many2x_fields.ttype == "many2one":
                                    if values.get(i):
                                        ...
                                        if fetch_m2o.id:
                                            pur_id.update({technical_fields_name: fetch_m2o.id})
                                        else:
                                            raise ValidationError(
                                ...
                                if many2x_fields.ttype == "many2many":
                                    ...
                                    if values.get(i):
                                        if ";" in values.get(i):
                                            ...
                                            m2m_value_lst.append(m2m_id.id)
                                    pur_id.update({technical_fields_name: m2m_value_lst})
                            else:
                                raise ValidationError(
                        ...
                        if normal_fields.id:
                            if normal_fields.ttype == "boolean":
                                pur_id.update({normal_details: values.get(i)})
                                ...
                                pur_id.update({normal_details: float_value})
                                ...
                                pur_id.update({normal_details: int_value})
